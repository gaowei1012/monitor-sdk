import { httpMetrics, mechanismType, MPerformanceNavigationTiming, OriginInformation, PageInformation, PerformanceEntryHander, ResourceFlowTiming, ViewModel } from '../types'
